...
# drive at a slight counter clockwise arc for a set time period (default 1
# second)
...
# A slightly longer example program showing how a robot may follow a
# simple path
...
def test_drive():
    ...
    # There is no difference between setting speed or distance negative, both
    # work
    drivetrain.straight(-25, 0.8)
