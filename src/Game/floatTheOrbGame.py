...
class Orb(pygame.sprite.Sprite):
    ...
    def get_alpha_float_factor(self):
        ...
        # -(GRAVITY*1.5)*(power - self.min_alpha)/(self.max_alpha - self.min_alpha)
        self.float_factor = power
...
class FloatTheOrb(EventClass):
    def __init__(
        ...
        self.button_sin = tk.Button(
            master=self.frame, text="Play Game", command=self.start_pygame)
