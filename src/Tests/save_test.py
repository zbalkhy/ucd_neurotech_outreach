...
#super basic unit tests just to make sure stuff ends up dumped to json, no tkinter
@pytest.fixture
def setup_teardown():
...
def test_save_classifier(setup_teardown):
    ...
    np.testing.assert_array_equal(loaded_classifier.label0_datasets["set0"], dataset0)
