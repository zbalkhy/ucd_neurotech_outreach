...
class ClassifierView(EventClass):
    def __init__(self, frame: tk.Frame, view_model: ClassifierViewModel):
        ...
        self.grid_frames = create_grid(
            self.inner_frame, 1, 2, None, True, False)
        ...
        # Name entry
        tk.Label(self.grid_frames[0][0], text="Classifier Name:").grid(
            row=0, column=0, padx=5, pady=5, sticky="w")
        self.name_entry = tk.Entry(
            self.grid_frames[0][0],
            textvariable=self.classifier_name,
            width=20)
        self.name_entry.grid(row=0, column=1, padx=5, pady=5, sticky="w")

        # Label 0 dataset selector
        tk.Label(self.grid_frames[0][0], text="Label 0 Datasets:").grid(
            row=1, column=0, padx=5, pady=5, sticky="w")
        self.label0_listbox = tk.Listbox(
            self.grid_frames[0][0],
            selectmode=MULTIPLE,
        ...
        tk.Label(self.grid_frames[0][0], text="Label 1 Datasets:").grid(
            row=2, column=0, padx=5, pady=5, sticky="w")
        self.label1_listbox = tk.Listbox(
            self.grid_frames[0][0],
            selectmode=MULTIPLE,
            exportselection=False,
            height=5)
        ...
        # Feature selector
        tk.Label(self.grid_frames[0][1], text="Features:").grid(
        ...
        # Filter selector
        tk.Label(self.grid_frames[0][1], text="Filters:").grid(
    ...
    def create_classifier(self):
        ...
        self.view_model.create_classifier(
            name, datasets0, datasets1, features, filters)
